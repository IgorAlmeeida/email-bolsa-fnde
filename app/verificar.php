...
$mail->SMTPAuth = true;
$mail->Username = 'petcriativacao@gmail.com';
$mail->Password = 'petuag2019';
$mail->Port = 587;
...
foreach ($linha as $result){
    $is_enviado = enviar_email($mail,$result['email_pessoa'], $result['nome_pessoa'], $result['cpf_pessoa'], $result['hash_pessoa'], $result['bolsa'], $result['valor_bolsa']);
...
function enviar_email($mail,$email, $nome, $cpf, $hash, $mes, $valor){
 
    try {
 
        $mail->setFrom('petcriativacao@gmail.com');
